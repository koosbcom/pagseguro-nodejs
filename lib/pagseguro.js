...
(function() {
  ...
  pagseguro = (function() {
    ...
    pagseguro.prototype.buyer = function(buyer) {
      ...
      if (this.mode === 'subscription' || this.mode === 'transparente-sandbox') {
      ...
      if(this.mode === 'transparente-sandbox') {
        this.obj.sender.documents = [{
          document: {
            type: buyer.documentType,
            value: buyer.documentValue
          }
        }]
      }
      return this;
      ...
      switch (this.mode) {
        ...
        case 'sandbox':
          ...
          if (shippingInfo.complement != null) {
            this.obj.shipping.address.complement = shippingInfo.complement;
          }
    ...
    //Adicionando creditCard
    pagseguro.prototype.creditCard = function(creditCardInfo) {
      switch (this.mode) {
        case 'payment':
          break;
        case 'sandbox':
        ...
        case 'transparente-sandbox':
          this.obj.creditCard = {};
          this.obj.creditCard.token = creditCardInfo.token;
          this.obj.creditCard.installment = {
            quantity: creditCardInfo.installmentQuantity,
            noInterestInstallmentQuantity: creditCardInfo.noInterestInstallmentQuantity,
            value: creditCardInfo.installmentValue
          };
          this.obj.creditCard.holder = {
            name: creditCardInfo.holderName,
            documents: [{
              document: {
                type: creditCardInfo.documentType,
                value: creditCardInfo.documentValue
              }
            }],
            birthDate: creditCardInfo.holderBirthDate,
            phone: {
              areaCode: creditCardInfo.holderAreaCode,
              number: creditCardInfo.holderNumber
            }
          };
          this.obj.creditCard.billingAddress = {
            street: creditCardInfo.street,
            number: creditCardInfo.number,
            complement: creditCardInfo.complement,
            district: creditCardInfo.district,
    ...
    pagseguro.prototype.setShippingRequired = function(required) {
      this.obj.shippingAddressRequired = required;
      return this;
    };
